...
class SubJanelaPlanoCurricular extends StatelessWidget {
  NivelNavegacao nivelNavegacao;
  SubJanelaPlanoCurricular({this.nivelNavegacao}) {
    log("$nivelNavegacao - Tamanho da Pilha: ${observadorSistema.pilhaDeniveisNavegacaoEdadoActual.length}");
  }
  @override
  Widget build(BuildContext context) {
    String subTitulo = gerarTextoParaButao(nivelNavegacao).contains("Nova") ? gerarTextoParaButao(nivelNavegacao).replaceAll("Nova", "") : gerarTextoParaButao(nivelNavegacao).replaceAll("Novo", "");
    return Column(
      children: [
...
class ListaDadosPlanoCurricular extends StatelessWidget {
  ...
  List definirListaDadosAtomicosAseremExibidos(NivelNavegacao nivelNavegacao) {
    if (NivelNavegacao.periodos == nivelNavegacao) {
      ...
      return (PlanoCurricular.pegarObjectoComBaseCaminhoAteUltimoNivel() as Cursos).anos;
    } else if (NivelNavegacao.semestres == nivelNavegacao) {
      return (PlanoCurricular.pegarObjectoComBaseCaminhoAteUltimoNivel() as Anos).semestres;
    } else if (NivelNavegacao.cadeiras == nivelNavegacao) {
      return (PlanoCurricular.pegarObjectoComBaseCaminhoAteUltimoNivel() as Semestres).cadeiras;
    }
  }
}
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              mainAxisSize: MainAxisSize.max,
              children: [
                Text("${definirTextoAserExibidoBaseadoNoTipoDado(cadaDadoAtomico)}"),
                InkWell(
                    onTap: () {
                      gerarDialogoRemoverPlanoCurricular(
                          context,
                          observadorSistema.pilhaDeniveisNavegacaoEdadoActual.top()["nivelNavegacao"],
